    ...
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<WalletType>().HasData(
                new WalletType { Id = Guid.Parse("67453687-E268-4F32-8FB8-0E7C77DE2C71"), Name = "Ví tạm thời",         Description = "Ví tạm thời của nhà đầu tư",                     Mode = ModeEnum.INVESTOR.ToString(),        Type = TypeEnum.I1.ToString(), CreateDate = localDate },
                new WalletType { Id = Guid.Parse("E3B41A08-135B-4FB3-BF1F-4D3675D39F96"), Name = "Ví đầu tư chung",     Description = "Ví đầu tư chung của nhà đầu tư",                 Mode = ModeEnum.INVESTOR.ToString(),        Type = TypeEnum.I2.ToString(), CreateDate = localDate },
                new WalletType { Id = Guid.Parse("BA9BAF2F-B063-41A2-808B-A452AFA3E57F"), Name = "Ví tạm ứng",          Description = "Ví tạm ứng của nhà đầu tư",                      Mode = ModeEnum.INVESTOR.ToString(),        Type = TypeEnum.I3.ToString(), CreateDate = localDate },
                new WalletType { Id = Guid.Parse("4E24A3D5-9AED-4DB2-87F5-BD69C55899B7"), Name = "Ví dự án thanh toán", Description = "Ví dự án thanh toán của nhà đầu tư",             Mode = ModeEnum.INVESTOR.ToString(),        Type = TypeEnum.I4.ToString(), CreateDate = localDate },
                new WalletType { Id = Guid.Parse("C485DC8B-B61D-4DE9-8939-4E765A3F9E7D"), Name = "Ví thu tiền",         Description = "Ví thu tiền của nhà đầu tư",                     Mode = ModeEnum.INVESTOR.ToString(),        Type = TypeEnum.I5.ToString(), CreateDate = localDate },
                
                new WalletType { Id = Guid.Parse("0568667C-1E13-440B-8D4A-077288AA9919"), Name = "Ví tạm thời",         Description = "Ví tạm thời của người quản lý dự án",            Mode = ModeEnum.PROJECT_MANAGER.ToString(), Type = TypeEnum.P1.ToString(), CreateDate = localDate },
                new WalletType { Id = Guid.Parse("05D47EB3-06A5-4718-A46A-D62494DEE371"), Name = "Ví thanh toán chung", Description = "Ví thanh toán chung của người quản lý dự án",    Mode = ModeEnum.PROJECT_MANAGER.ToString(), Type = TypeEnum.P2.ToString(), CreateDate = localDate },
                new WalletType { Id = Guid.Parse("A036A7D2-980B-41B2-8EC2-06BFF8782B66"), Name = "Ví đầu tư dự án",     Description = "Ví đầu tư dự án của người quản lý dự án",        Mode = ModeEnum.PROJECT_MANAGER.ToString(), Type = TypeEnum.P3.ToString(), CreateDate = localDate },
                new WalletType { Id = Guid.Parse("D7ED0979-285F-4EC0-9F6B-AE95FCFA9207"), Name = "Ví thanh toán dự án", Description = "Ví thanh toán dự án của người quản lý dự án",    Mode = ModeEnum.PROJECT_MANAGER.ToString(), Type = TypeEnum.P4.ToString(), CreateDate = localDate },
                new WalletType { Id = Guid.Parse("01E8B6E9-5E53-478B-8077-19215D2B404A"), Name = "Ví thu tiền",         Description = "Ví thu tiền của người quản lý dự án",            Mode = ModeEnum.PROJECT_MANAGER.ToString(), Type = TypeEnum.P5.ToString(), CreateDate = localDate }
                );
